...
public class CameraMovementsAuthoringData : MonoBehaviour, IConvertGameObjectToEntity
{
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        //
        // For example,
        dstManager.AddComponentData(entity, new CameraMovementsData { cameraSensitivity = this.cameraSensitivity, invertAxis = this.invertAxis });
