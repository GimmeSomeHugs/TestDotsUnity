...
public class LifeTimeAuthoringData : MonoBehaviour, IConvertGameObjectToEntity
{
    [SerializeField]
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        dstManager.AddComponentData(entity, new LifeTimeData { maxLifeTime = this.maxLifeTime, currentLifeTime = 0f });
