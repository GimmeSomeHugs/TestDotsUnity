...
public class AddRotationEulerXYZ : MonoBehaviour, IConvertGameObjectToEntity
{
	public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
	{
         dstManager.AddComponent<RotationEulerXYZ>(entity);
        if(dstManager.HasComponent<MovementsData>(entity))
		{
            var movements = dstManager.GetComponentData<MovementsData>(entity);
            movements.maxJumpTimer = movements.jumpTimer;
            dstManager.SetComponentData(entity, movements);
		}
	}
